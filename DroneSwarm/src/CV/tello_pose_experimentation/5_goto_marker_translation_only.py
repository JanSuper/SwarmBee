...
# TODO very important to have correct values here:
id_to_find = 3  # was 1 originally
marker_size = 2 # size in cm  # was 17.5 originally (the bigger the marker the easier it is to recognize)
